...
class LSTMDataset(Dataset):
    ...
    def __getitem__(self, idx: int
        ...
        '''return (
            torch.FloatTensor(self.input_data[idx]),torch.FloatTensor(self.output_data[idx]),self.helpers[idx],)'''
...
class ModelUtils:
    ...
    def save_checkpoint_epoch(self, save_dir: str, state: Dict[str, Any], epoch=0) -> None:
        """Save checkpoint file.
        ...
        """
        filename = "{}/LSTM_{}.pth.tar".format(save_dir,
                                                      epoch)
        torch.save(state, filename)
    ...
    def load_checkpoint(
            ...
            use_cuda: bool) -> Tuple[int, int, float]:
        """Load the checkpoint.
